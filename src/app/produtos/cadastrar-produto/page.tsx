	...
	return (
		<div className="">
			<div className="flex flex-col">
				...
				<form className="flex flex-col gap-10 font-raleway relative max-w-[70%] mx-auto">
					...
					<div>
						...
						<div className="text-center font-raleway flex flex-col gap-4 mt-6 border-dashed border-black/30 border-2 px-48 py-4">
							...
							<input className='hidden' type="file" id="idImagem" alt="enviar imagem" accept='image/jpg, image/png, image/jpeg' onChange={handleChange} required/>
						</div>
					</div>
