...
import iconFigma from "@/image/icon-fig3.png"
import iconInsta from "@/image/icon-insta.png"
import iconGit from "@/image/icon-git.png"
...
export default function Rodape() {
    ...
    return (
        <footer className="bg-black absolute min-w-full bottom-0">
